...
export default function CourseForm() {
  ...
  useEffect(() => {
    async function fetchCategories() {
      try {
        const response = await axios.get("https://api-academy.tabaani.co/api/categories"); // Replace with your actual API endpoint for categories
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://api-academy.tabaani.co/api/course", formData);
