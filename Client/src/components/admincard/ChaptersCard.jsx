...
const ChaptersCard = ({ chapters = [], lessons = [],
  ...
  const handleDeleteChapter = async (chapterId) => {
    try {
      await axios.delete(`https://api-academy.tabaani.co/api/course/${id}/deletechapter/${chapterId}`);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const chaptersResponse = await axios.get(`https://api-academy.tabaani.co/api/course/${id}/getchapter`);
        ...
        const chaptersWithLessons = await Promise.all(chaptersWithId.map(async (chapter) => {
          const lessonsResponse = await axios.get(`https://api-academy.tabaani.co/api/course/${id}/chapter/${chapter.id}/getlesson`);
  ...
  const handleAddChapter = async () => {
    try {
      const response = await axios.post(
        `https://api-academy.tabaani.co/api/course/${id}/add-chapter`,
        {
  ...
  const handleAddLesson = async (e) => {
    ...
    try {
      if (openChapter !== null) {
        ...
        if (chapter) {
          const response = await axios.post(
            `https://api-academy.tabaani.co/api/course/${id}/chapter/${chapter.id}/add-lesson`,
            {  
